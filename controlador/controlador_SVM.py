...
class SimpleMonitor13(simple_switch_13.SimpleSwitch13):
    ...
    def entrenamiento(self):
        ...
        self.logger.info("Entrenando Modelo SVM")
        ...
        self.flow_model = clf.fit(X_flow_train, y_flow_train)
        ...
        self.logger.info("Matríz de Confusión SVM")
    ...
    def flow_predict(self):
        try:
            ...
            file0.close()
            hub.sleep(3)
            # if len(y_flow_pred) > 10:
            #     self.logger.info("Porcentaje de accuracy {0:.2f} %".format((len(y_flow_pred))/(len(y_flow_pred)+ddos_traffic))*100)
        except:
            print("dataset predict vacío!")
            pass
